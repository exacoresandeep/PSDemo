...
Route::prefix('sales')->middleware('auth')->group(function () {
  ...
  //  Route::get('/dashboard', [DashboardController::class, 'salesDashboard'])->name('sales.dashboard');
    ...
    ->name('sales.employee.export');
        ...
        Route::get('/get-employees-ajax', [EmployeeController::class, 'getEmployeesAjax'])
    ->name('sales.employee.getEmployeesAjax');
        Route::post('/import-sap', [EmployeeController::class, 'importSAP'])
    ->name('sales.employee.importSAP');
